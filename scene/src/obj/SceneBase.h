...
class SceneBase{
 public:
  ...
  moveit::planning_interface::PlanningSceneInterface* ur5_planning_scene_interface = 0;
  ...
  // Constants
  const double CALL_DILAY = 0.0;      // 0 > may reduce warnings about ApplyPlanningScene
  ...
  bool ApplyAttachedCollisionObject(moveit_msgs::AttachedCollisionObject &msg, double delay = -1);

  bool ApplyCollisionObject(moveit_msgs::CollisionObject &msg, double delay = -1);
